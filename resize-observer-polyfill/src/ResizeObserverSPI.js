...
export default class ResizeObserverSPI {
    ...
    _assertElement(target) {
        if (target.ownerDocument) {
            // This tests checks to see if target is an Element. Since the element
            // may be in another window, we need to get the element's window to do an instanceof check.
